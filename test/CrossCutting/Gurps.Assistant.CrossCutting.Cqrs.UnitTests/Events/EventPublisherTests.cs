...
namespace Gurps.Assistant.CrossCutting.Cqrs.UnitTests.Events
{
  public class EventPublisherTests
  {
    ...
    private readonly Mock<IBusMessageDispatcher> _busMessageDispatcher;

    private readonly Mock<IEventHandler<SomethingCreated>> _eventHandler1;
    private readonly Mock<IEventHandler<SomethingCreated>> _eventHandler2;
